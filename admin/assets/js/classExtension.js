...
var CreatUser= {
    ...
    init: function(obj){
        ...
        //feature synchronization, tries to assign any possible feature that has been added to the default features of a particular user
            ...
            if(User.feature[feat]){
                ...
                if(count_dom1 < 6){
                 ...
                 dom1+='<div class="card box-shadow f-home-'+feat+'-icon" style="max-width: 250px;">'+
                    ...
                    '<cite class="f-home-custom-hide">'+feat+'</cite></a></div>';
